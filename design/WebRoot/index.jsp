...
<script type="text/javascript">
  ...
  <div class="modal-dialog">
	...
	<a class="play-icon popup-with-zoom-anim" href="#small-dialog1"></a>
	<!---pop-up-box---->  
	...
	<c:if test="${username != null }">
  	...
  	<c:if test="${username != null }">
  		<a href="tuichu.do" class="btn btn-primary"  >
    	退出</a>
  	</c:if>
  	<c:if test="${username == null}" >
                    ...
                    <div class="col-md-8" style="border-right: 1px dotted #C2C2C2;padding-right: 30px;">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="Login">
                                <form role="form" class="form-horizontal" action="denglu.do">
                                <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label" >
                                        用户名：</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="email1" placeholder="QQ/电话" name="username"/>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane" id="Registration">
                                <form role="form" class="form-horizontal" action="zhuce.do">
                                <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label">
                                        性别</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label for="mobile" class="col-sm-2 control-label">
                                        账号</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"  placeholder="QQ/电话" name="username"/>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row text-center sign-with">
                            ...
                            <div class="col-md-12">
                                <div class="btn-group btn-group-justified">
                                    <a href="jingxi.jsp" target="_blank">点这里</a>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <!-- Mega Menu -->
					<li class="dropdown w3_megamenu-fw"><a href="movies.html" data-toggle="dropdown" class="dropdown-toggle">热映的影片<b class="caret"></b></a>
                            ...
                            <li class="w3_megamenu-content">
                                <div class="row">
									...
									<div class="menu-featured-movies">
										<h3 class="title">点击照片查看详情</h3>
										<div class="col-md-2 menu-featured-movies-img">
											<a href="userSelect.do?photo=images/mf1.jpg"><img src="images/mf1.jpg" alt="" /></a>
										</div>
										<div class="col-md-2 menu-featured-movies-img">
											<a href="userSelect.do?photo=images/mf2.jpg"><img src="images/mf2.jpg" alt="" /></a>
										</div>
										<div class="col-md-2 menu-featured-movies-img">
											<a href="userSelect.do?photo=images/mf3.jpg"><img src="images/mf3.jpg" alt="" /></a>
										</div>
					...
					<li class="dropdown w3_megamenu-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">查询全部影片<b class="caret"></b></a>
                      <ul class="dropdown-menu half">
                            <li class="w3_megamenu-content withdesc">
                                <div class="row">
									<h5 class="movies-page">加快脚步 - <a href="userXS.do">点这里</a> </h5>
                                </div>
                            </li>
                        </ul>
					<!-- 到这 -->
					</li>
					<li class="dropdown w3_megamenu-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">热播喜剧<b class="caret"></b></a>
                      <ul class="dropdown-menu half3">
                            <li class="w3_megamenu-content withoutdesc">
								...
								<div class="e-buy-tickets">
									<a href="userSelect.do?photo=images/f2.jpg">查看影片详情</a>
								</div>
							</div>
                                    </div>
                                    <div class="col-sm-3">
								...
								<div class="e-buy-tickets">
									<a href="userSelect.do?photo=images/f3.jpg">查看影片详情</a>
								</div>
							</div>
                                    </div>
                                    <div class="col-sm-3">
								...
								<div class="e-buy-tickets">
									<a href="userSelect.do?photo=images/f4.jpg">查看影片详情</a>
								</div>
							</div>
                                    </div>
                                    <div class="col-sm-3">
								...
								<div class="e-buy-tickets">
									<a href="userSelect.do?photo=images/f1.jpg">查看影片详情</a>
								</div>
							</div>
                                    </div>
                                </div>
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">热播爱情片<b class="caret"></b></a>
							 <ul class="dropdown-menu half3">
                            <li class="w3_megamenu-content withoutdesc">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="userSelect.do?photo=images/me1.jpg"><img src="images/me1.jpg" alt="" /></a>
									<a class="plays-go">Volleyball is a team sport</a>
								</div>
							</div>
                                    </div>
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="userSelect.do?photo=images/me2.jpg"><img src="images/me2.jpg" alt="" /></a>
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="userSelect.do?photo=images/me3.jpg"><img src="images/me3.jpg" alt="" /></a>
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="userSelect.do?photo=images/me4.jpg"><img src="images/me4.jpg" alt="" /></a>
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">即将上映的影片<b class="caret"></b></a>
                            ...
                            <li class="dropdown-submenu">
								...
								<ul class="dropdown-menu">
									<li><a href="kongbu.jsp?photo=images/j1.jpg">恐怖片</a></li>
		 ...
		 <div class="col-md-4 banner-right">
			...
			<div id="myTabContent" class="tab-content">
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">				  
                    <h2 style="color:#f00">温馨提示:</h2><br />
                    <h4>如需帮助请联系客服!</h4>
                   	<p style="color:#00f">电话：13504477891</p>
                   	<p style="color:#00f">QQ：541194741</p>
                   	<p style="color:#00f">邮箱：541194741@qq.com</p>
			...
			<li>
				...
				<div class="date-city">
					...
					<div class="buy-tickets">
						<a href="userSelect.do?photo=images/r1.jpg">查看影片详情</a>
					</div>
				</div>
			</li>
			<li>
				...
				<div class="date-city">
					...
					<div class="buy-tickets">
						<a href="userSelect.do?photo=images/r2.jpg">查看影片详情</a>
					</div>
				</div>
			</li>
			<li>
				...
				<div class="date-city">
					...
					<div class="buy-tickets">
						<a href="userSelect.do?photo=images/r3.jpg">查看影片详情</a>
					</div>
				</div>
			</li>
			<li>
				...
				<div class="date-city">
					...
					<div class="buy-tickets">
						<a href=""userSelect.do?photo=images/r4.jpg"">查看影片详情</a>
					</div>
				</div>
			</li>
			<li>
				...
				<div class="date-city">
					...
					<div class="buy-tickets">
						<a href=""userSelect.do?photo=images/r5.jpg"">查看影片详情</a>
					</div>
				</div>
			</li>
			<li>
				...
				<div class="date-city">
					...
					<div class="buy-tickets">
						<a href=""userSelect.do?photo=images/r6.jpg"">查看影片详情</a>
					</div>
				</div>
			</li>
		</ul>
